...
class StructureProject:
    ...
    def __init__(self):
        ...
        self._all_dirs["base_data"] = os.path.join(PROJECT_DIR, "data")
        self._all_dirs["base_output"] = os.path.join(PROJECT_DIR, "output")
        self._all_dirs["base_scripts"] = os.path.join(PROJECT_DIR, "scripts")
        self._all_dirs["base_config"] = os.path.join(PROJECT_DIR, "config")
